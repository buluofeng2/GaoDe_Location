package com.sfx.caretestmap.Navi;
...
import com.sfx.caretestmap.R;

import java.util.ArrayList;
import java.util.List;

public class NviTest extends AppCompatActivity implements AMapNaviListener, View.OnClickListener, AMap.OnMapLoadedListener {
    /**
     * 导航对象(单例)
     */
